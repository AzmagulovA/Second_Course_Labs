...
namespace Lab11
{
    public class Person : IExecutable, IComparable, ICloneable
    {
        ...
        public override bool Equals(object other)//Функция по определению равенства other с текущим элементом 
        {
            var x = (Person)other;
        ...
        public override int GetHashCode()//Переопределение хеш функции
        {
            Random r= new Random();
            int n = Age;
            return  n;
